...
<mujoco model="default_scene">
    ...
    <worldbody>
        ...
        <light pos="0 0 1.5" dir="0 0 -1" directional="true"/>
        <!-- 预定义 10 个 mocap body -->
        <body name="debug_axis_0" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_1" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_2" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_3" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_4" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.05" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_5" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_6" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_7" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_8" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
        <body name="debug_axis_9" pos="0 0 -1" mocap="true">
            <geom type="cylinder" fromto="0 0 0 0.1 0 0" size="0.005" rgba="1 0 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0.1 0" size="0.005" rgba="0 1 0 0.2" contype="2" conaffinity="0" group="2"/>
            <geom type="cylinder" fromto="0 0 0 0 0 0.1" size="0.005" rgba="0 0 1 0.2" contype="2" conaffinity="0" group="2"/>
        </body>
